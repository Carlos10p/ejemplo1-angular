...
export class CinepolisComponent implements OnInit {
  ...
  calcular(){
    ...
    if(cantVoletas>7){
      this.resultado='El maximo de boletas son 7 por persona';
      ...
      // this.nombre = 'El nombre es '+this.nombre;
      // this.cantCompradores = 'Los compradores son '+this.cantCompradores;
      // this.tarjeta = 'Tiene tarjeta? '+this.tarjeta;
      // this.cantVoletas = 'Los compradores son '+this.cantVoletas;
    }
